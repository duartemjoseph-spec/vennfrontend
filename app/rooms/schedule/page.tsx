...
const pmTimes = ["12 PM", "1 PM", "2 PM", "3 PM", "4 PM", "5 PM", "6 PM", "7 PM", "8 PM", "9 PM", "10 PM", "11 PM"];
const amTimes = ["12 AM", "1 AM", "2 AM", "3 AM", "4 AM", "5 AM", "6 AM", "7 AM", "8 AM", "9 AM", "10 AM", "11 AM"];

type SlotState = "available" | "busy" | "maybe";
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-4 rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800">
          ...
          <p>
            ...
            Your friends will see this when coordinating plans.
          </p>
        </div>
