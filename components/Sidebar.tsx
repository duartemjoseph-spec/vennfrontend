...
export default function Sidebar() {
  ...
  return (
    <aside className="w-full h-screen rounded-3xl bg-white sticky top-0 border border-zinc-200 p-5 shadow-sm">
      <div className="mb-6">
      ...
      <div className="space-y-2 text-sm">
        ...
        <button
          ...
          className="w-full text-left rounded-xl px-3 py-2 text-zinc-800 hover:bg-zinc-100 text-[16px] cursor-pointer"
        >
          Log Out
        </button>
      </div>
